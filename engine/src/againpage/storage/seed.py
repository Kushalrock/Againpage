...
from againpage.core.models import (
    NewIssue, IssueContent, Connection, StandaloneSummary, Question, Wildcard, Forgotten,
)
from againpage.storage.repository import Repository

AMOR_FATI = IssueContent(
    title="Amor Fati",
    dek="Today's edition · on acceptance, and the strange freedom in it",
    standfirst=("Three thinkers you've filed across the centuries — a Greek slave, "
    ...
    connections=[
        Connection(
            ...
            text=("Both stare at the same fact — a cosmos that owes you no meaning — and answer "
        ...
        Connection(
            ...
            text=("You linked these once and let the thread lapse. Niebuhr's prayer — serenity to "
        ...
        Connection(
            ...
            text=("You've never connected these, though they sit at opposite ends of one axis. "
        ...
        Connection(
            ...
            text=("Sixteen centuries apart, both recast necessity as the rational order of things "
        ...
        Connection(
            ...
            text=("You flagged these as 'the same move, restated every few centuries,' and the "
        ...
        Connection(
            ...
            text=("With no possible contact between Rome and the Buddhist world, an emperor and "
    ...
    standalone_summaries=[
        StandaloneSummary(
            ...
            text=("Nietzsche's amor fati is the love of fate — not mere tolerance of what happens "
        ...
        StandaloneSummary(
            ...
            text=("Epictetus opens the Enchiridion by splitting the world in two: what is up to "
        ...
        StandaloneSummary(
            ...
            text=("From the Meditations: Marcus's private instruction that 'the impediment to "
    ...
    questions=[
        Question(text="What are you still spending your peace trying to control?"),
        Question(text="If this exact year returned, unchanged, forever — could you say yes to it?"),
        Question(text="Where is an obstacle quietly asking to be treated as the assignment?"),
    ],
    apply=[
    ...
    wildcard=Wildcard(
        bridge=("Amor fati has an unlikely modern home: the cockpit. Apollo's flight controllers "
                ...
                "discipline."),
        trivia=("Epictetus was lame in one leg — by one account, his master broke it. He is said "
    ...
    forgotten=Forgotten(
        ...
        nudge=("Filed two years ago from a note on Epicurus, opened once. The Garden's quieter "
               "answer to the same problem the Stoa keeps wrestling — worth meeting again."),
    ),
)

async def seed_sample_issue(repo: Repository, user_id: UUID) -> UUID:
    row = await repo.insert_issue(NewIssue(
        user_id=user_id, issue_no=47, issue_date=date(2026, 6, 30), theme_id=None,
        theme_label="Amor Fati", reading_min=7, word_target=1540,
        content=AMOR_FATI.model_dump(), payload=None, model="seed"))
    return row.id
